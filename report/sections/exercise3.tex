...
$q=0.05$ branch is close to zero by the negative-correlation ($\rho_1=-0.7$, weight $0.3$); 
in the positive region ($u_2$ large) the $q=0.05$ quantile is lifted because the positive-correlation
($\rho_2=0.4$, weight $0.7$) dominates. The mixture therefore generates a non-monotone,
