...
$T=\ExTwoT$ trading days from \ExTwoDateStart{} to \ExTwoDateEnd. 
...
\paragraph{Marginal volatility -- GARCH(1,1).}
...
\paragraph{Marginal volatility with leverage -- GJR(1,1).}
...
\label{eq:dcc-LL-t}
\end{align}
with $\eta_{it}=t_\nu^{-1}(\hat u_{it})$ obtained from the EDF margins. 
